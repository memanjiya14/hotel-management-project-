...
<body>
  <nav>
    <div class="logo">
      <img class="hotellogo" src="./image/hotellogo.jpg" alt="logo">
      <p>Hotel Grand Pragati</p>
    </div>
    <ul>
  ...
  <section id="firstsection" class="carousel slide carousel_section" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="welcomeline">
          <h5 class="welcometag">Welcome to Hotel_Grand Pragati</h5>
        </div>
...
?>
  ...
  <section id="contactus">
    ...
    <div class="createdby">
      <h5>Created by @mohamad husain </h5>
    </div>
  </section>
</body>
